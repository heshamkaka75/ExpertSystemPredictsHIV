...
namespace ExpertSystemPredictsHIV.Controllers
{
    public class HospitalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,State,Address,Phone")] Hospital hospital)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,State,Address,Phone")] Hospital hospital)
        {
            if (id != hospital.Id)
            {
                return NotFound();
